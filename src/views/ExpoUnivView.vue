<template>
    ...
    <ul class="list-decimal font-Roboto text-xl ml-10">
        ...
        <li>La cible : Tout public</li>
        <li>Positionnement / Promesse / Justification de la promesse : Le thème de l’Expo 2025 est Concevoir la Société du Futur, Imaginer Notre Vie de Demain. Il invite les visiteurs à réfléchir à la vie qu’ils souhaitent mener et favorise la création d’une société durable.
        Le thème de l’exposition universelle d’Osaka a été sélectionné pour répondre aux constantes évolutions sociales. Le développement de nouvelles technologies telles que l’IA et la biotechnologie aura un impact significatif sur l’humanité, en allongeant l’espérance de vie, par exemple.
        Le thème a également été influencé par la COVID-19. La pandémie a entraîné un changement dans les valeurs et les modes de vie des individus et a créé
        de nouveaux défis. L’Expo 2025 est une opportunité pour les pays du monde entier de se réunir pour discuter du thème de la vie.
