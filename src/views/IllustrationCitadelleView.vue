<template>
    <h2 class="font-script text-3xl text-center font-bold mt-8 text-gray-600 underline underline-offset-8 decoration-double p-2">Illustration de la Citadelle de Besançon</h2>
