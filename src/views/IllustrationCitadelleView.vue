<template>
    ...
    <img src="../assets/images/citadelle_de_besancon.webp" alt="Image de la citadelle de Besançon en noir et blanc" class="scale-75 hover:scale-90 block m-auto"  onclick="showModal('https://www.kindacode.com/wp-content/uploads/2022/07/flower-1.jpeg')">
...
<script>
import LightBoxes from "../components/LightBoxes.vue";

export default {
  components: { LightBoxes },
}
