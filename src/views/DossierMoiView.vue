<template>
    ...
    <p class="mt-4 ml-4 font-Roboto text-xl mr-4"> Mon <span class="font-semibold text-gray-600">idée directrice</span> a été celle de la <span class="font-semibold text-gray-600">rétrospection et légèrement de l’introspection</span> pour dire que mon passé raconte mon présent. Pour les réaliser, j’ai donc choisi des photos de moi plus petite et pris une lumière naturelle avec une profondeur de champ nette. </p>
        ...
        <p class="mt-2 ml-4 font-Roboto text-xl mr-4"> Je superpose mon <span class="font-semibold text-gray-600">passé devant mon présent.</span> Je vous regarde en vous laissant percevoir mes sentiments, mon âme et ma personnalité. Il s’agit ici de rétrospective ainsi qu’une légère introspection. </p>
    ...
    <p class="mt-2 ml-4 font-Roboto text-xl mr-4"> Je pense que l’autobiographie est importante à notre stade de notre vie premièrement cela permet de <span class="font-semibold text-gray-600">laisser une trace de ce qui reste de notre enfance</span> et deuxièmement cela nous fait <span class="font-semibold text-gray-600">réfléchir sur notre avenir</span>.</p> 
    <p class="mt-2 ml-4 font-Roboto text-xl mr-4"> Cette autobiographie, est donc un moyen de réfléchir à la <span class="font-semibold text-gray-600">manière de construire sa vie</span> et surtout de la raconter à soi-même et aux autres.</p>
</template>