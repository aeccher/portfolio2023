<template>
    ...
    <h3 class="font-Roboto text-xl text-center font-bold mt-8 text-gray-600  outline-dotted p-2">CRÉATION DE L'IDENTITÉ VISUELLE / HARMONIE COLORÉE</h3>
        ...
        <img src="../assets/images/logo_sae202.webp" alt="Décomposition de l'identité visuelle du site" class="w-1/2 h-1/2 m-auto py-8">
        <img src="../assets/images/harmonie_coloree.webp" alt="Harmonie colorée du site" class="w-1/2 h-1/2 m-auto">
