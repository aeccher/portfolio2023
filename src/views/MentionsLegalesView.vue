<template>
    ...
    <p class="font-Roboto text-xl p-4 mr-4">La présentation et chacun des éléments, y compris les marques, logos et noms de domaine, apparaissant sur le site <span class="underline">https://portfolio.agathe-eccher.fr</span> sont protégés par les lois en vigueur sur la propriété intellectuelle, et appartiennent à Agathe ECCHER, ou font l'objet d'une autorisation d'utilisation. 
